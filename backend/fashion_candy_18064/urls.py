"""fashion_candy_18064 URL Configuration
...
admin.site.site_header = "fashion candy"
admin.site.site_title = "fashion candy Admin Portal"
admin.site.index_title = "fashion candy Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="fashion candy API",
        default_version="v1",
        description="API documentation for fashion candy App",
    ),
    public=True,
